        ...
        function loadEvents() {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventSourceSuccess: function (content) {
                    if (!loaded) {
                        populateTypeFilter(content.types);
                        loaded = true;
                    }
                ...
                events: function (info, successCallback, failureCallback) {
                    ...
                    var url = "https://script.google.com/macros/s/AKfycbxNnO6euZTMq_q8EM4k0bvYsO2QTCDZ3yGevR0eSkWCmoTrfsbdEQlPViNxIDH9GY-Ctw/exec";
                    var start = info.startStr;
                    var end = info.endStr;

                    fetch(`${url}?start:${start}&end:${end}`, requestOptions)
                        .then(response => response.json())
                        .then((result) => {
                            successCallback(result.events);
                        });
                },
                //events: "https://script.google.com/macros/s/AKfycbxNnO6euZTMq_q8EM4k0bvYsO2QTCDZ3yGevR0eSkWCmoTrfsbdEQlPViNxIDH9GY-Ctw/exec",
